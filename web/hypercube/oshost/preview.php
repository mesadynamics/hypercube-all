...
echo sprintf("<li id='current'><a href='preview.php?widget_id=%s&hash=%s'><span>From your Friend</span></a></li>", $_REQUEST['widget_id'], $_REQUEST['hash']);
...
EndHereDoc2;
	...
	echo sprintf("<div id='copycancel'>or <a href='index.php?%s'><span>cancel</span></a></div>", $template);
