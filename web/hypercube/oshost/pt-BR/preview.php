...
echo sprintf("<li id='current'><a href='preview.php?widget_id=%s&hash=%s'><span>De seu Amigo</span></a></li>", $_REQUEST['widget_id'], $_REQUEST['hash']);
...
EndHereDoc2;
	...
	echo sprintf("<div id='copycancel'>ou <a href='index.php?%s'><span>cancelar</span></a></div>", $template);
