...
<div id='tabs1'><ul>
   <li id='current'><a href='#'><span>Propriedades do Widget</span></a></li>
</ul></div>
...
EndHereDoc2;
	...
	echo "<div id='inputform'><table><tr><td id='tabler'>Nome:</td><td>";
	echo sprintf("<input type='text' maxlength='64' size='45' name='title' value='%s' />", $title);
	echo "</td></tr><tr><td id='tabler'>Não listar no perfil:</td><td>";
...
$html3 = <<<EndHereDoc3
<div id='save2'><a href='javascript: submitform()'>salvar mudanças</a>
</div>
EndHereDoc3;

	echo $html3;

	echo sprintf("<div id='cancel3'>ou <a href='index.php?%s'><span>cancelar</span></a></div>", $template);
}
else {
$html2 = <<<EndHereDoc2
<div id='error'>
     <h1>Erro</h1>
     Desculpe, este widget não está mais disponível.
</div>
EndHereDoc2;
