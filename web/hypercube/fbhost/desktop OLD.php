...
<fb:explanation>
     ...
     <p>We'll be rolling out a new version soon that fully integates with your Hypercube widgets in Facebook: when you
          ...
          <tr>
               <td class="list">
                    <div class="list_item clearfix">
                    	Version 0.2a:
                    	<ul>
                    		<li>In sync with Facebook release.</li>
                    		<li>Various fixes and improvements.</li>
                     	</ul>
                    	System Requirements: 
                    	<ul>
                    	<li>Windows XP w/ <a href="http://msdn2.microsoft.com/en-us/netframework/aa731542.aspx" target="_blank">.NET 2.0</a> (minimum)</li>
                    	<li>Windows Vista (recommended)</li>
                    	<li>Adobe Flash Player (recommended)</li>
                    	</ul>
					</div>
               </td>
               <td class="spacer"></td>
               <td class="list">
                    <div class="list_item clearfix">
                    	...
                    	System Requirements: 
 						<ul>
 							<li>OS X 10.3.9 (minimum)</li>
 							<li>OS X 10.4 or later (recommended)</li>
 						</ul>
 					</div>
               </td>
          </tr>
