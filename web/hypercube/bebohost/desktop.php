...
<sn:explanation>
     <sn:message>Web widgets on your desktop</sn:message>
     ...
     <p>We'll be rolling out a new version soon that fully integrates with your Hypercube widgets in Bebo: when you
     add a widget here, you'll be able to open it on your desktop automatically (and web widgets you add to your desktop will be accessible here in Bebo).</p>
     ...
     <table class="lists" cellspacing="0" border="0">
          ...
          <tr>
               <td class="list">
                   	...
                   	<img src="http://www.amnestywidgets.com/hypercube/bebohost/images/hcwin.png" />
                   	</div>
              </td>
               <td class="spacer"></td>
               <td class="list">
                   	<div class="list_item clearfix">
                   	<img src="http://www.amnestywidgets.com/hypercube/bebohost/images/hcmac.png" />
                   	</div>
               </td>
          </tr>
          <tr>
